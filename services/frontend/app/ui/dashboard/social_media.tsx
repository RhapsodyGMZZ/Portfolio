...
import { CADDY_URL, ITEM } from "@app/lib/constants";
...
export default function Socials() {
    return (
        <motion.div variants={ITEM} className="bg-white shadow-lg rounded-lg p-8 flex flex-col w-full lg:w-1/4 h-auto ">
            <Image src={`${CADDY_URL}/image?opt=avatar.jpg`} width={200} height={200} alt="Photo of me" className="rounded-xl mb-4 self-center" />
