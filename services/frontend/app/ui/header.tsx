    ...
    return (
        <header className="bg-white shadow-lg h-2/12">
            <nav className="py-8 px-10 flex flex-start flex-row items-center relative">
                <Image src={`${CADDY_URL}/image?opt=avatar-header.jpg`} alt="Little avatar with my picture in it" width={50} height={50} className=" absolute border border-blue-500 rounded-full"/>
                <Link href={"/dashboard"}>
