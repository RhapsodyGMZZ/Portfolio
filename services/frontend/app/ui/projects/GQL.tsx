                ...
                <motion.div className="w-full flex flex-col items-center" variants={CONTAINER} initial="initial" animate="animation">
                    ...
                    {authState &&
                        <motion.div variants={ITEM}>
                            <img src={`${API_BASE_URL}/image?opt=graphQL.png`} alt="login page" className="mb-5 border-2" width={800} height={800} />
                        </motion.div>
                    }
                    ...
                    {homeState &&
                        <>
                            ...
                            <motion.div variants={ITEM}>
                                <img src={`${API_BASE_URL}/image?opt=graphql-home.png`} alt="posts page" className="mb-5 border-2" width={800} height={800} />
                                <img src={`${API_BASE_URL}/image?opt=graph-projects.png`} alt="posts page" className="mb-5 border-2" width={800} height={800} />
                            </motion.div>
                        </>
                    }
                </motion.div>
