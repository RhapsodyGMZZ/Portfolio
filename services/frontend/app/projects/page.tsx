...
export default function Page() {
    return (
        <div className="flex flex-col w-full justify-around items-center">
            <motion.div className="flex flex-row flex-wrap bg-white rounded-lg shadow-xl w-full md:w-1/2 p-5 mb-8" whileHover={{ scale: 1.1 }}>
            ...
            <motion.div className="flex flex-row flex-wrap bg-white rounded-lg shadow-xl w-fit md:w-1/2 p-5" whileHover={{ scale: 1.1 }}>
