  ...
  return (
    <main className="flex justify-center items-center h-[80vh]">
      <div className="bg-white max-w-md w-full rounded-lg shadow-xl h-auto p-8">
        ...
        <p className="text-black text-center p-3 font-medium">Welcome to my portfolio, this will be updated every time I complete a project which I think is worth being there. This portfolio is developed in Next.JS and Tailwind.css for the frontend and the backend is in GO (Golang).</p>
